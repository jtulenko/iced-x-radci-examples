...
def pysochron(burial_core, var_list, const_list):
    ...
    pretype = float(var_list[0])
    external_uncertainty = float(var_list[1])
    no_3sigma = float(var_list[2])
    MC_line_plot = float(var_list[3])
    MC_pt_plot = float(var_list[4])
    force_zero_pb = float(var_list[5])
    plot_inh = float(var_list[6])
    ...
    tau10_mean = float(const_list[0])
    tau26_mean = float(const_list[1])
    Rsurf_mean = float(const_list[2])
    Rpost_mean = float(const_list[3])
    rho_mean = float(const_list[4])
    Lambda_mean = float(const_list[5])
    p10_SLHL_mean = float(const_list[6])
    tau10_unc = float(const_list[7])
    tau26_unc = float(const_list[8])
    Rsurf_unc = float(const_list[9])
    Rpost_unc = float(const_list[10])
    rho_unc = float(const_list[11])
    Lambda_unc = float(const_list[12])
    p10_SLHL_unc = float(const_list[13])
